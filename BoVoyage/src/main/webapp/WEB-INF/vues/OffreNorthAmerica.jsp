...
<body>
	...
	<!-- 				<th>Operation</th> -->
	<!-- 			</tr> -->
	<%-- 			<c:forEach var="eur" items="${listeNA}"> --%>
	<!-- 				<tr> -->
	<%-- 					<td>${eur.id}</td> --%>
	<%-- 					<td>${eur.reference}</td> --%>
	...
	<div class="container">
		<div class="row justify-content-md-center">
			<div class="col-md-4">
				<c:forEach begin="0" end="${fn:length(listeNA)/3}" var="ctr"
					items="${listeNA}" varStatus="loop">
			...
			<div class="col-md-4">
				<c:forEach begin="${(fn:length(listeNA)/3) + 1}"
					end="${(fn:length(listeNA)/3)*2}" var="ctr" items="${listeNA}"
					varStatus="loop">
					<div class=" borderexample">
						<a href="${pageContext.request.contextPath}/OffreCTRL/${ctr.id}"
							target="_blank" style="text-decoration: none"> ID : ${ctr.id}
			...
			<div class="col-md-4">
				<c:forEach begin="${((fn:length(listeNA)/3)*2)+1}" var="ctr"
					items="${listeNA}" varStatus="loop">
					<div class=" borderexample">
						<a href="${pageContext.request.contextPath}/OffreCTRL/${ctr.id}"
							target="_blank" style="text-decoration: none"> ID : ${ctr.id}
