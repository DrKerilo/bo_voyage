...
<hr />
	...
	<form:form cssClass="form-horizontal" method="POST"
		...
		<div class="form-group">
			<form:label cssClass="col-sm-offset-2 col-sm-2 control-label" path="id">id</form:label>
			<div class="col-sm-4">
	...
	<div class="form-group">
		...
		<div class="form-group">
			<form:label cssClass="col-sm-offset-2 col-sm-2 control-label" path="prixPublic">prixPublic</form:label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<form:label cssClass="col-sm-offset-2 col-sm-2 control-label" path="prixBoV">prixBoV</form:label>
			<div class="col-sm-4">
