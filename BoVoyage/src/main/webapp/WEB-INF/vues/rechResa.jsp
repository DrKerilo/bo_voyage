...
<body>
	...
	<nav class="navbar navbar-inverse">
		<ul class="nav nav-tabs">
			<li><a
				href="${pageContext.request.contextPath}/clientCTRL/listeResa">Liste</a></li>
	...
	<div align="center" class="table-responsive">
		...
		<table class="table table-hover" style="text-align: center;">
			...
			<tr>
				...
				<td><a href="<c:url value='/clientCTRL/supLinkResa/${resaFind.id}'/>">Supprimer</a>
					| <a href="<c:url value='/clientCTRL/modifLinkResa?pId=${resaFind.id}'/>">Modifier</a></td>
			</tr>
