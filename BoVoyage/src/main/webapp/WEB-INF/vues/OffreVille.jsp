						...
						<ul class="nav navbar-nav">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<c:url value='/carteCTRL/listeVilleope'/>">Europe</a></li>
	...
	<div class="container">
		...
		<div class="container">
			<div class="row justify-content-md-center">
				<div class="col-md-4">
					<c:forEach begin="0" end="${fn:length(listeVille)/3}" var="ctr"
						items="${listeVille}" varStatus="loop">
				...
				<div class="col-md-4">
					<c:forEach begin="${(fn:length(listeVille)/3) + 1}"
						end="${(fn:length(listeVille)/3)*2}" var="ctr" items="${listeVille}"
						varStatus="loop">
						<div class=" borderexample">
							<a href="${pageContext.request.contextPath}/OffreCTRL/${ctr.id}"
								target="_blank" style="text-decoration: none"> ID :
				...
				<div class="col-md-4">
					<c:forEach begin="${((fn:length(listeVille)/3)*2)+1}" var="ctr"
						items="${listeVille}" varStatus="loop">
						<div class=" borderexample">
							<a href="${pageContext.request.contextPath}/OffreCTRL/${ctr.id}"
								target="_blank" style="text-decoration: none"> ID :
