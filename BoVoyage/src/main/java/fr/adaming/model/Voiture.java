...
public class Voiture {
	...
	public Voiture(String loueur, String reference, String categorie, long nbplaces, byte[] photo, Offre offreVoyage) {
		super();
		this.loueur = loueur;
	...
	public Voiture(int id, String loueur, String reference, String categorie, long nbplaces, byte[] photo,
			Offre offreVoyage) {
		super();
		this.id = id;
		this.loueur = loueur;
